...
STEERING_LEFT_PWM = 510         #pwm value for full left steering (DEFAULT: 460)
...
# ROI_CROP_TOP = 80                    #the number of rows of pixels to ignore on the top of the image
...
# 
# #WEB CONTROL
WEB_CONTROL_PORT = 8889             # which port to listen on when making a web controller
...
GYM_CONF = { "body_style" : "donkey", "body_rgb" : (0, 0, 0), "car_name" : "Andrea", "font_size" : 100} # body style(donkey|bare|car01) body rgb 0-255
GYM_CONF["racer_name"] = "Andrea"
GYM_CONF["country"] = "CH"
GYM_CONF["bio"] = "FUSI Organizator"
# 
